...
function doGet(e) {
  ...
  try {
    ...
    switch (functionName) {
      ...
      case 'sendSignupsToEmail': result = sendSignupsToEmail(params.startDateStr, params.endDateStr, params.targetEmail); break;
      // --- LINE Messaging API ---
...
function sendSignupsToEmail(startDateStr, endDateStr, targetEmail) {
